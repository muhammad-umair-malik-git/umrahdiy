...
const FlightSelector = ({ onFlightSelect, passengerCounts }) => {
  ...
  const originCities = cities.filter(city => ['AKL', 'SYD', 'MEL', 'CGK', 'KUL', 'SIN'].includes(city.code));
...
{t('chooseFlightsDepartureReturn')}
          </p>
        </div>
        <div className="hidden md:block">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-4 border border-blue-200">
            <p className="text-blue-800 font-semibold text-sm">{t('stepOneOfThree')}</p>
            <p className="text-blue-600 text-xs">{t('selectFlights')}</p>
          </div>
        </div>
      </div>
...
{t('passengerDetails')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-2">
            <label className="block text-sm font-semibold text-slate-700">{t('adults')}</label>
            <select className="w-full px-4 py-3 bg-white border-2 border-slate-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 appearance-none cursor-pointer">
              <option value="1">{t('oneAdult')}</option>
              <option value="2">{t('twoAdults')}</option>
              <option value="3">{t('threeAdults')}</option>
              <option value="4">{t('fourAdults')}</option>
            </select>
          </div>
          <div className="space-y-2">
            <label className="block text-sm font-semibold text-slate-700">{t('childrenAge')}</label>
            <select className="w-full px-4 py-3 bg-white border-2 border-slate-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 appearance-none cursor-pointer">
              <option value="0">{t('zeroChildren')}</option>
              <option value="1">{t('oneChild')}</option>
              <option value="2">{t('twoChildren')}</option>
              <option value="3">{t('threeChildren')}</option>
            </select>
          </div>
          <div className="space-y-2">
            <label className="block text-sm font-semibold text-slate-700">{t('infantsAge')}</label>
            <select className="w-full px-4 py-3 bg-white border-2 border-slate-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-200 appearance-none cursor-pointer">
              <option value="0">{t('zeroInfants')}</option>
              <option value="1">{t('oneInfant')}</option>
              <option value="2">{t('twoInfants')}</option>
            </select>
          </div>
        </div>
      </div>
...
{t('outboundFlightSaudi')}
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-green-700">{t('from')}</label>
              <select 
              ...
              >
                <option value="">{t('selectOriginCity')}</option>
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-green-700">{t('to')}</label>
              <select 
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-green-700">{t('departureDate')}</label>
              <input 
                type="date" 
...
{t('returnFlightSaudi')}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-blue-700">{t('from')}</label>
              <select 
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-blue-700">{t('to')}</label>
              <select 
            ...
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-blue-700">{t('departureDate')}</label>
              <input 
                type="date" 
      ...
      {showResults && (
        <div className="mt-12 animate-fadeInUp">
          <div className="text-center mb-8">
            <h3 className="text-3xl font-bold text-slate-900 mb-2">{t('availableFlights')}</h3>
            <p className="text-slate-600 text-lg">{t('selectPreferredFlights')}</p>
          </div>
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h4 className="text-2xl font-bold text-slate-900">{t('outboundFlights')}</h4>
            </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="ml-6 text-right">
                      ...
                      <div className="text-slate-500 text-sm">{t('perPerson')}</div>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h4 className="text-2xl font-bold text-slate-900">{t('returnFlights')}</h4>
            </div>
